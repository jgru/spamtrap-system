from datamodels import FeedMsg, NetworkEvent, NetworkEntityFactory, Observer, EntityEnum, Network
...
class DionaeaProcessor(BaseProcessor):
    ...
    def process_connection(self, entry: FeedMsg):
        ...
        dst_ip = "127.0.0.1"
        src = NetworkEntityFactory.get_from_ip(src_ip, parsed['remote_port'], EntityEnum.unspecified)
        dst = NetworkEntityFactory.get_from_ip(dst_ip, parsed['local_port'], EntityEnum.honeypot)
