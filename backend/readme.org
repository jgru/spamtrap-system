...
To deploy a dockerized ES use the docker-compose-file inside [[file:/media/user01/data/Dropbox/study/masterthesis/lab/spamtrap-system/periphery/elasticstack/][../periphery/elasticstack/]] and run ~docker-compose up~ inside this directory.
